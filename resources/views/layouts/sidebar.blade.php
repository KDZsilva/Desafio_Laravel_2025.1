...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
 ...
 <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-fit h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pl-0 pb-4 overflow-y-auto overflow-x-hidden bg-white dark:bg-gray-800">
       <ul class="space-y-2 font-medium w-6 hover:w-fit transition duration-400 ease-in-out">
