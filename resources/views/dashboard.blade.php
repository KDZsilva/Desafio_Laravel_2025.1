    ...
    <div class="py-12 bg-[#000027]">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex">
            <div class="bg-blue-400 overflow-hidden shadow-sm sm:rounded-lg flex align-middle justify-center p-4 gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-box-seam text-[46px] self-center text-white" viewBox="0 0 16 16">
            ...
            <div class="bg-blue-400 overflow-hidden shadow-sm sm:rounded-lg flex align-middle justify-center p-4 gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-shop text-[46px] self-center text-white" viewBox="0 0 16 16">
